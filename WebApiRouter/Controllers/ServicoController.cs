...
public class ServicosController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<ActionResult<ServicoDTO>> CriarServico([FromBody] ServicoCreateDTO dto)
    {
        var servico = new Servico
        {
            Datacriacao = dto.Datacriacao,
            Datafechamento = dto.Datafechamento,
            SituacaoServicoId = dto.SituacaoServicoId,
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<ServicoDTO>> ObterServicoPorId(int id)
    {
    ...
    private async Task<ServicoDTO?> MapToDTO(int id)
    {
    ...
    [HttpGet("rota/{rotaId}")]
    public async Task<ActionResult<IEnumerable<ServicoDTO>>> ObterServicosPorRota(int rotaId)
    {
